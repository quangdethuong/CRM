                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select name="job_idProfile" class="form-control form-control-line">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="nameProfile" placeholder="Tên công việc"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select name="user_idProfile" class="form-control form-control-line">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input name="start_dayProfile" type="text" placeholder="dd/MM/yyyy"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="end_dayProfile" placeholder="dd/MM/yyyy"
                            ...
                            <c:if test="${isEdit == true}">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="status_idProfile" class="form-control form-control-line">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <a href="<c:url value="/profile?id=${userId}"/>" class="btn btn-primary">Quay lại</a>
                                </div>
                            </div>
                            </form>
                        </div>
